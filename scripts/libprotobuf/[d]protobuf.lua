...
--[[local base_path = "prototest.libprotobuf."
--local pb = require "pb"
local wire_format = require base_path .. "wire_format"
local type_checkers = require base_path .. "type_checkers"
local encoder = require base_path .. "encoder"
local decoder = require base_path .. "decoder"
local listener_mod = require base_path .. "listener"
local containers = require base_path .. "containers"
local descriptor = require base_path .. "descriptor"
local FieldDescriptor = descriptor.FieldDescriptor
local text_format = base_path .. require "text_format"
]]--
