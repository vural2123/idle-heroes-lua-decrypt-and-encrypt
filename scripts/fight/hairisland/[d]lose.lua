...
function ui.create(video)
    ...
    local cfg = cfgfloatland[video.stage]
    ...
    --else
        layer.addOkButton(function()
            require("fight.hairisland.loading").backToUI(video)
        end)
    --end
    ...
    if video.hurts and #video.hurts > 0 then
        ...
        --require("fight.airisland.win").addScoreAndHurtsSum(layer, video.hurts, cfg)
    end
