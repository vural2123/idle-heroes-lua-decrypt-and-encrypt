...
function ui.create()
    ...
    local showTitle = lbl.createFont1(26, i18n.global.arena_buy_tickets.string, ccc3(0xe6, 0xd0, 0xae))
    showTitle:setPosition(board_bg:getContentSize().width/2, board_bg_h-30)
    board_bg:addChild(showTitle, 1)
    
    local showTitleShade = lbl.createFont1(26, i18n.global.arena_buy_tickets.string, ccc3(0x59, 0x30, 0x1b))
    ...
    -- ticket icon
    local icon_ticket = img.createItem(ITEM_ID_ARENA)--img.createUISprite(img.ui.casino_chip)
    ...
    local lbl_pay = lbl.createFont2(18, num2KM(bagdata.gem()) .. "/0")
    ...
    btn_buy:registerScriptTapHandler(function()
        ...
        netClient:pvp_ticket(params, function(__data)
            ...
            bagdata.items.add({ id = ITEM_ID_ARENA, num = buyCount })
            btn_buy:setEnabled(true)
