...
function ui.create(_anim)
    ...
    local layer = boardlayer.create(boardlayer.TAB.FEED, _anim)
    ...
    local lbl_send = lbl.createFont1(18, i18n.global.setting_feed_submit.string, ccc3(0x73, 0x3b, 0x05))
