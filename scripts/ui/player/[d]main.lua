...
function ui.create()
    ...
    local showTitle = lbl.createFont1(26, i18n.global.player_title.string, ccc3(0xe6, 0xd0, 0xae))
    showTitle:setPosition(board:getContentSize().width/2, 378)
    board:addChild(showTitle, 1)
    local showTitleShade = lbl.createFont1(26, i18n.global.player_title.string, ccc3(0x59, 0x30, 0x1b))
    ...
    if headData.showRedDot() then
        addRedDot(showHeadSprite, {
            px = showHeadSprite:getContentSize().width - 10,
            py = showHeadSprite:getContentSize().height - 10,
        })
    end
