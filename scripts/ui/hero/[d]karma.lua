...
function karma.create(heroData)
    ...
    local title = lbl.createFont3(24, "FETTERS", ccc3(0xe6, 0xd0, 0xae))
    ...
    local link = {}
    if cfghero[heroData.id].linkId then
        link[#link + 1] = 
    end
    ...
    for i=1, 10 do
        ...
        local showSkillName = lbl.createFont1(18, "Tiger Heros:", ccc3(0x5a, 0x32, 0x1e))
