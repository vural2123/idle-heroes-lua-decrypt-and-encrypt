    ...
    local function createRecords(logs, orgData)
        ...
        for i, v in ipairs(logs) do
            ...
            if v.vid then
                ...
                local function onVideo()
                    ...
                    net:video(params, function(__data)
                        ...
                        layer:addChild(require("ui.3v3arena.videoDetail").create(__data.video, i, orgData), 10000)
                    end) 
                end
            ...
            btnHead:registerScriptTapHandler(function()
                layer:addChild(require("ui.3v3arena.player").create(v.rival), 1000)
            end)
                ...
                btnBattle:registerScriptTapHandler(function() 
                    ...
                    if havTicket >= ticketCost then
                        ...
                        net:player(params, function(__data)
                            ...
                            layer:addChild(require("ui.3v3arena.select").create({type = "3v3arenaAtk", info = info, cost = ticketCost}))
                        end) 
                    else
