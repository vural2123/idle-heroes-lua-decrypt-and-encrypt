...
function ui.create()
    ...
    --elseif not APP_CHANNEL then
    --    link_url = "https://www.facebook.com/Idleheroes"
    --    bannerLabel = img.createUISprite("activity_follow_des.png")
    --elseif APP_CHANNEL == "" then
    --    link_url = "https://www.facebook.com/Idleheroes"
    --    bannerLabel = img.createUISprite("activity_follow_des.png")
    --elseif isOnestore() or isAmazon() then
    --    link_url = "https://www.facebook.com/Idleheroes"
    --    bannerLabel = img.createUISprite("activity_follow_des.png")
    else
        link_url = "https://www.facebook.com/Idleheroes"
    ...
    --elseif APP_CHANNEL ~= "IAS" and i18n.getCurrentLanguage() == kLanguageKorean then
    --    banner = img.createUISprite("activity_follow_kr.png")
    --elseif APP_CHANNEL ~= "IAS" and i18n.getCurrentLanguage() == kLanguageJapanese then
    --    banner = img.createUISprite("activity_follow_jp.png")
    --else
    --end
