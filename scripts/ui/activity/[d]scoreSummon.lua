...
function ui.create()
    ...
    --img.unload(img.packedOthers.ui_activity_summon_score_cn)
    --if i18n.getCurrentLanguage() == kLanguageChinese then
        --img.load(img.packedOthers.ui_activity_summon_score_cn)
    --else
        img.load(img.packedOthers.ui_activity_summon_score)
    --end
    local banner
    if i18n.getCurrentLanguage() == kLanguageKorean then
        banner = img.createUISprite("activity_summon_score_board_kr.png")
    elseif i18n.getCurrentLanguage() == kLanguageChineseTW then
        banner = img.createUISprite("activity_summon_score_board_tw.png")
    elseif i18n.getCurrentLanguage() == kLanguageJapanese then
        banner = img.createUISprite("activity_summon_score_board_jp.png")
    elseif i18n.getCurrentLanguage() == kLanguageRussian then
        banner = img.createUISprite("activity_summon_score_board_ru.png")
    elseif i18n.getCurrentLanguage() == kLanguagePortuguese then
        banner = img.createUISprite("activity_summon_score_board_pt.png")
    elseif i18n.getCurrentLanguage() == kLanguageSpanish then
        banner = img.createUISprite("activity_summon_score_board_sp.png")
    elseif i18n.getCurrentLanguage() == kLanguageChinese then
        banner = img.createUISprite("activity_summon_score_board_cn.png")
    else
        banner = img.createUISprite(img.ui.activity_summon_score_board)
    end
    ...
    lbl_cd:setPosition(CCPoint(287, 34))
    ...
    lbl_cd_des:setPosition(CCPoint(362, 34))
    banner:addChild(lbl_cd_des)

    if i18n.getCurrentLanguage() == kLanguageRussian then
        lbl_cd_des:setPosition(CCPoint(287-40, 34))
        lbl_cd:setAnchorPoint(CCPoint(0, 0.5))
        lbl_cd:setPosition(CCPoint(lbl_cd_des:boundingBox():getMaxX()+10, 34))
    end
    ...
    local function createItem(itemObj)
        ...
        for ii=1,#itemObj.rewards do
            ...
            if _obj.type == ItemType.Equip then  -- equip
                print("summondebug:", _obj.id, _obj.num)
