...
local vp_ids = {
    IDS.WEEKLY_GIFT.ID,
    IDS.WEEKLY_GIFT_2.ID,
    IDS.WEEKLY_GIFT_3.ID,
    IDS.WEEKLY_GIFT_4.ID,
}
...
function ui.create()
    ...
    if i18n.getCurrentLanguage() == kLanguageKorean then
        banner = img.createUISprite("activity_weekly_gift_kr.png")
    elseif i18n.getCurrentLanguage() == kLanguageChineseTW then
        banner = img.createUISprite("activity_weekly_gift_tw.png")
    elseif i18n.getCurrentLanguage() == kLanguageJapanese then
        banner = img.createUISprite("activity_weekly_gift_jp.png")
    elseif i18n.getCurrentLanguage() == kLanguageRussian then
        banner = img.createUISprite("activity_weekly_gift_ru.png")
    else
        banner = img.createUISprite(img.ui.activity_weekly_gift)
    end
