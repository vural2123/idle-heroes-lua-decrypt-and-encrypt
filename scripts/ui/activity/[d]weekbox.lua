...
local vp_ids = {
    ...
    IDS.WEEKYEARBOX_2.ID,
    IDS.WEEKYEARBOX_3.ID,
}
...
function ui.createItemTip(parentLayer, itemId)
    ...
    tipstitle:setPosition(bg_w/2, 205-30)
    ...
    line:setPosition(CCPoint(bg_w/2, 205-56))
    bg:addChild(line)
