...
function ui.create()
    ...
    local function createRankList(ranks)
        ...
        for i, v in ipairs(ranks) do
            ...
            local titleLayer = lbl.createFont1(14, i18n.global.trial_rank_layer.string, ccc3(0x7a, 0x53, 0x34))
            titleLayer:setPosition(523, 53)
            showBg:addChild(titleLayer)

            local showLayer = lbl.createFont1(22, v.stage, ccc3(0x9c, 0x45, 0x2d))
    ...
    local function onEnter()
        ...
        addWaitNet()
        net:trial_rank(params, function(__data)
            delWaitNet()

            tbl2string(__data)
            local ranks = __data.rank or {}
