...
function ui.create()
    ...
    local origin_price = "원가 $194.99"
    local sale_price = "$14.99"
    if isOnestore() then
        origin_price = "원가 235,950"
        sale_price = "18,700"
    end
    local board
    ...
    if i18n.getCurrentLanguage() == kLanguageKorean then
        ...
        --lbl_origin_price:setPosition(CCPoint(330, 144))
        ...
        --del_line:setPosition(CCPoint(330, 144))
        ...
        --lbl_sale_price:setPosition(CCPoint(330, 112))
