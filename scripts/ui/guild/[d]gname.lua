...
function ui.create(callback)
    ...
    -- title
    local lbl_title = lbl.createFont1(24, i18n.global.guild_modify_name.string, ccc3(0xe6, 0xd0, 0xae))
    lbl_title:setPosition(CCPoint(bg_w/2, bg_h-29))
    bg:addChild(lbl_title, 2)
    local lbl_title_shadowD = lbl.createFont1(24, i18n.global.guild_modify_name.string, ccc3(0x59, 0x30, 0x1b))
    lbl_title_shadowD:setPosition(CCPoint(bg_w/2, bg_h-31))
    bg:addChild(lbl_title_shadowD)

    local lbl_des = lbl.createFont1(18, i18n.global.guild_modify_name_des.string, ccc3(0x71, 0x3f, 0x16))
    ...
    edit_name:setFontColor(ccc3(0x35, 0x57, 0x04))
    ...
    local lbl_create = lbl.createFont1(16, i18n.global.guild_btn_confirm.string, ccc3(0x71, 0x3f, 0x16))
    ...
    if bagdata.gem() < gdata.NAME_COST then
        lbl_gem:setColor(ccc3(0xff, 0x2c, 0x2c))
    end
