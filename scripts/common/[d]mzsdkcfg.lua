...
cfg.pay = function(params, callback)
    ...
    getOrder(oparams, function(__data)
        ...
        local ucParams = {
            ...
            sign = netOrder.sign,
            sign_type = netOrder.sign_type .. "",
            buy_amount = netOrder.buy_amount .. "",
            user_info = netOrder.user_info .. "",
            total_price = netOrder.total_price .. "",
            product_id = netOrder.product_id .. "",
            product_subject = netOrder.product_subject .. "",
            product_body = netOrder.product_body .. "",
            product_unit = netOrder.product_unit .. "",
            app_id = netOrder.app_id .. "",
            uid = netOrder.uid .. "",
            product_per_price = netOrder.product_per_price .. "",
            create_time = netOrder.create_time .. "",
            pay_type = netOrder.pay_type .. "",
        }
