...
cfg.pay = function(params, callback)
    ...
    getOrder(oparams, function(__data)
        ...
        require("data.takingdata").onChargeReq(wfParams.app_order_id, netOrder.product_id, netOrder.money_amount, "CNY", 0, "third")
